...
async function selectBidder(bidder) {
  ...
  bidderList.querySelectorAll('.bidder-item').forEach(el =>
    el.classList.toggle('active', el.dataset.bidder === bidder)
  );
